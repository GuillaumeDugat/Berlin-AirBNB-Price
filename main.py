...
def main():
    ...
    # model = create_ada_boost(best_model=True)
    # model = create_gradient_boosted_tree(best_model=True)
    # model = create_xg_boost(best_model=True)
    # model = create_bagging_model(best_model=True)
    # model = create_SVR_model(best_model=True)
    # model = create_decision_tree_model(best_model=True)
    # model = create_random_forest_model(best_model=True)
